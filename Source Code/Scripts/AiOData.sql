...
(UNIX_TIMESTAMP(concat(curdate(), ' 05:30:00')), 1, 'Avramo',1,'616f8ccc-51c5-4bc8-aa55-56f3a58ea507'),
(UNIX_TIMESTAMP(concat(curdate(), ' 05:45:00')), 3, 'Glisen',1,'616f8ccc-51c5-4bc8-aa55-56f3a58ea507'),
(UNIX_TIMESTAMP(concat(curdate(), ' 06:06:00')), 2, 'Samson',1,'616f8ccc-51c5-4bc8-aa55-56f3a58ea507'),
(UNIX_TIMESTAMP(concat(curdate(), ' 07:12:00')), 5, 'Matovi',1,'616f8ccc-51c5-4bc8-aa55-56f3a58ea507'),
(UNIX_TIMESTAMP(concat(curdate(), ' 05:30:00')), 6, 'Billye',1,'616f8ccc-51c5-4bc8-aa55-56f3a58ea507'),
(UNIX_TIMESTAMP(concat(curdate(), ' 05:45:00')), 8, 'Petrov',2,'ff88f34b-c278-4d4d-898e-aff6489eee68'),
(UNIX_TIMESTAMP(concat(curdate(), ' 06:06:00')), 4, 'Ollett',2,'ff88f34b-c278-4d4d-898e-aff6489eee68'),
(UNIX_TIMESTAMP(concat(curdate(), ' 13:12:00')), 7, 'Brixey',2,'ff88f34b-c278-4d4d-898e-aff6489eee68'),
(UNIX_TIMESTAMP(concat(curdate(), ' 05:30:00')), 9, 'Pardoe',2,'ff88f34b-c278-4d4d-898e-aff6489eee68'),
(UNIX_TIMESTAMP(concat(curdate(), ' 14:45:00')), 10, 'Maitl',2,'ff88f34b-c278-4d4d-898e-aff6489eee68'),
(UNIX_TIMESTAMP(concat(curdate(), ' 06:06:00')), 11, 'Kulle',3,'db46cf3b-8450-43cd-bbc3-085dbff0100c'),
(UNIX_TIMESTAMP(concat(curdate(), ' 16:12:00')), 12, 'Resto',4,'25798ba5-431c-40e9-b125-61a8d0d23e4b'),
(UNIX_TIMESTAMP(concat(curdate(), ' 16:30:00')), 13, 'Beaty',5,'4ae1a9cd-da45-40f6-96f1-84abd846f235'),
(UNIX_TIMESTAMP(concat(curdate(), ' 16:45:00')), 14, 'Mucci',6,'a8da32f2-45c6-4aca-bf7c-c94d543d1d3f'),
(UNIX_TIMESTAMP(concat(curdate(), ' 07:06:00')), 15, 'Annak',7,'531b84fd-a725-45f8-89a2-ae977699f1e6'),
(UNIX_TIMESTAMP(concat(curdate(), ' 07:12:00')), 16, 'Strai',8,'3d393d4f-5d1b-44e7-b007-8ba93d1f8057'),
(UNIX_TIMESTAMP(concat(curdate(), ' 05:30:00')), 17, 'Reybu',9,'d64de149-7b26-4084-ac23-ff4a94d6af94'),
(UNIX_TIMESTAMP(concat(curdate(), ' 13:45:00')), 18, 'Paute',10,'80d69413-be92-4245-84d1-1a17af7414ba'),
(UNIX_TIMESTAMP(concat(curdate(), ' 13:06:00')), 19, 'Breen',11,'8630bbde-7273-46a3-8919-2cd5484552ad'),
(UNIX_TIMESTAMP(concat(curdate(), ' 14:12:00')), 20, 'Nothe',12,'358403b2-47c5-4f20-b071-462f316e48ed'),
(UNIX_TIMESTAMP(concat(curdate(), ' 15:30:00')), 21, 'Casla',13,'5f456152-069f-4b3c-90fb-81c29f5b2618'),
(UNIX_TIMESTAMP(concat(curdate(), ' 05:45:00')), 22, 'Piser',14,'529bd19c-c425-4ad8-8f8e-a94b0e60979d'),
(UNIX_TIMESTAMP(concat(curdate(), ' 16:06:00')), 23, 'Badma',15,'02e2ce0f-1605-484c-81e1-2d4471cf181b'),
(UNIX_TIMESTAMP(concat(curdate(), ' 18:12:00')), 24, 'Grege',16,'aef1910a-457d-4cde-bb04-c62cdfaeae4e'),
(UNIX_TIMESTAMP(concat(curdate(), ' 18:30:00')), 25, 'Gutee',17,'bd3a8a1a-8df6-4f78-956e-fdd2e10a2450'),
(UNIX_TIMESTAMP(concat(curdate(), ' 17:45:00')), 26, 'Pittl',18,'d6c0ffc9-5297-45ab-961c-1ae7463498ef'),
(UNIX_TIMESTAMP(concat(curdate(), ' 16:06:00')), 27, 'Patte',19,'7af8acc4-5183-4d42-bbd4-f42eddfe01a6'),
(UNIX_TIMESTAMP(concat(curdate(), ' 15:12:00')), 28, 'Musse',20,'c01cfef8-83d8-49f4-b546-a7bfcc669f99'),
(UNIX_TIMESTAMP(concat(curdate(), ' 14:30:00')), 29, 'Brumb',21,'4e227dba-6f98-40d6-9247-60720f214738'),
(UNIX_TIMESTAMP(concat(curdate(), ' 13:45:00')), 30, 'Raspi',22,'c77b3c25-eff0-4f74-97cf-92e6c4f9eada');
