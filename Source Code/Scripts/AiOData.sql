...
(UNIX_TIMESTAMP(concat(curdate(), ' 13:12:00')), 7, 2,'ju409'),
(UNIX_TIMESTAMP(concat(curdate(), ' 05:30:00')), 9, 2,'ju409'),
(UNIX_TIMESTAMP(concat(curdate(), ' 14:45:00')), 10,2,'ju409'),
(UNIX_TIMESTAMP(concat(curdate(), ' 06:06:00')), 11, 3,'qh729'),
(UNIX_TIMESTAMP(concat(curdate(), ' 16:12:00')), 12, 4,'gg486'),
(UNIX_TIMESTAMP(concat(curdate(), ' 16:30:00')), 13, 5,'ah714'),
(UNIX_TIMESTAMP(concat(curdate(), ' 16:45:00')), 14, 6,'ch536'),
...
(UNIX_TIMESTAMP(concat(curdate(), ' 13:45:00')), 18, 10,'kv808'),
(UNIX_TIMESTAMP(concat(curdate(), ' 13:06:00')), 19, 11,'ba104'),
(UNIX_TIMESTAMP(concat(curdate(), ' 14:12:00')), 20, 12,'dp550'),
(UNIX_TIMESTAMP(concat(curdate(), ' 15:30:00')), 21, 13,'ah714'),
(UNIX_TIMESTAMP(concat(curdate(), ' 05:45:00')), 22, 14,'vc268'),
(UNIX_TIMESTAMP(concat(curdate(), ' 16:06:00')), 23, 15,'tb066'),
(UNIX_TIMESTAMP(concat(curdate(), ' 18:12:00')), 24, 16,'gr418'),
(UNIX_TIMESTAMP(concat(curdate(), ' 18:30:00')), 25, 17,'fr595'),
(UNIX_TIMESTAMP(concat(curdate(), ' 18:30:00')), 31, null,'ah714'),
(UNIX_TIMESTAMP(concat(curdate(), ' 17:45:00')), 26, 18,'yz771'),
(UNIX_TIMESTAMP(concat(curdate(), ' 16:06:00')), 27, 19,'ji217'),
(UNIX_TIMESTAMP(concat(curdate(), ' 15:12:00')), 28, 20,'gy457'),
(UNIX_TIMESTAMP(concat(curdate(), ' 14:30:00')), 29, 21,'jj386'),
(UNIX_TIMESTAMP(concat(curdate(), ' 13:45:00')), 30, 22,'eo856');
